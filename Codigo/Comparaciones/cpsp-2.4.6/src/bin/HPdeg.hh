...
#include <cpsp/gecode/GC_HPThreading.hh>
	...
	public:
		...
		HPdegParameters(int argc, char** argv, cpsp::gecode::GC_HPThreading & threading) 
			throw(cpsp::Exception);
		
			//! destruction
		virtual ~HPdegParameters();
		
			//! whether or not in silent output mode
		bool
		isSilent(void) const { return silent; }
